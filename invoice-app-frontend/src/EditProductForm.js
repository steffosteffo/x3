...
function EditProductForm() {
  ...
  const fetchProducts= async () => {
    try {
     ...
     //const response = await axios.get('http://213.112.60.40:5000/api/products'); // STAR!22222d2
   //    const response = await axios.get('http://localhost:5000/api/products'); // STAR!22222d2
